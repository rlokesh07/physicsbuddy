...
class p0 {
	constructor(e, t, a, n, s, o, h, c) {
		...
		p && this.classes.push(p + '_fallback'),
			/[îïíì]/.test(this.text) && (this.text = $a[this.text]);
	}
	hasClass(e) {
		return q.contains(this.classes, e);
	}
...
B({
	...
	handler(r, e) {
		for (
			var { parser: t } = r, a = F(e[0], 'ordgroup'), n = a.body, s = '', o = 0;
			o < n.length;
			o++
		) {
			var h = F(n[o], 'textord');
...
var k0 = function (e, t) {
		...
		function V(fe) {
			for (var pe = 0; pe < fe.length; ++pe)
				pe > 0 && (H += 0.25), p.push({ pos: H, isDashed: fe[pe] });
		}
...
var _r = (r, e, t, a, n, s, o) => {
	...
	re = (r, e) => {
		var t,
			...
			s;
		r.type === 'supsub'
			? ((t = r.sup), (a = r.sub), (s = F(r.base, 'op')), (n = !0))
			: (s = F(r, 'op'));
		var o = e.style,
			h = !1;
...
var ta = (r, e) => {
		var t,
			...
			s;
		r.type === 'supsub'
			? ((t = r.sup), (a = r.sub), (s = F(r.base, 'operatorname')), (n = !0))
			: (s = F(r, 'operatorname'));
		var o;
		if (s.body.length > 0) {
			for (
...
m('\\dots', function (r) {
	...
	return (
		t in cr
			? (e = cr[t])
			: (t.slice(0, 4) === '\\not' ||
					(t in $.math && q.contains(['bin', 'rel'], $.math[t].group))) &&
				(e = '\\dotsb'),
		e
	);
});
...
class s4 {
	...
	isExpandable(e) {
		...
		return t != null
			...
			: F0.hasOwnProperty(e) && !F0[e].primitive;
	}
}
...
class Fe {
	...
	parseExpression(e, t) {
		for (var a = []; ; ) {
			...
			var n = this.fetch();
			if (
				Fe.endOfExpression.indexOf(n.text) !== -1 ||
				(t && n.text === t) ||
				(e && F0[n.text] && F0[n.text].infix)
			)
				break;
