...
var Ua = [
	...
	Ft = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
	Ht = function (e, t) {
...
class A0 {
	...
	havingStyle(e) {
		return this.style === e ? this : this.extend({ style: e, size: Ht(this.textSize, e) });
	}
	havingCrampedStyle() {
	...
	havingSize(e) {
		return this.size === e && this.textSize === e
			? this
			: this.extend({ style: this.style.text(), size: e, textSize: e, sizeMultiplier: Ft[e - 1] });
	}
	havingBaseStyle(e) {
		e = e || this.style.text();
...
var nt = {
	...
	$a = { ex: !0, em: !0, mu: !0 },
	gr = function (e) {
		return typeof e != 'string' && (e = e.unit), e in nt || e in $a || e === 'ex';
	},
	K = function (e, t) {
		var a;
...
class p0 {
	constructor(e, t, a, n, s, o, h, c) {
		...
		p && this.classes.push(p + '_fallback'),
			/[îïíì]/.test(this.text) && (this.text = Xa[this.text]);
	}
	hasClass(e) {
		return q.contains(this.classes, e);
	}
	toNode() {
		...
		this.italic > 0 &&
			...
			this.classes.length > 0 &&
				((t = t || document.createElement('span')), (t.className = L0(this.classes)));
		for (var a in this.style)
	...
	toMarkup() {
		var e = !1,
			t = '<span';
		this.classes.length &&
			((e = !0), (t += ' class="'), (t += q.escape(L0(this.classes))), (t += '"'));
		var a = '';
	...
	toMarkup() {
		...
		for (var t in this.attributes)
			Object.prototype.hasOwnProperty.call(this.attributes, t) &&
				(e += ' ' + t + '="' + q.escape(this.attributes[t]) + '"');
		e += '>';
...
class P0 {
	...
	toMarkup() {
		return this.alternate
			? '<path d="' + q.escape(this.alternate) + '"/>'
			: '<path d="' + q.escape(It[this.pathName]) + '"/>';
	}
}
class it {
	constructor(e) {
...
function i(r, e, t, a, n, s) {
	(X[r][n] = { font: e, group: t, replace: a }), s && a && (X[r][a] = X[r][n]);
}
var l = 'math',
	k = 'text',
	u = 'main',
...
for (var $0 = 0; $0 < 10; $0++) {
	var F0 = $0.toString();
	(I = String.fromCharCode(55349, 57294 + $0)),
		i(l, u, E, F0, I),
		i(k, u, v, F0, I),
		(I = String.fromCharCode(55349, 57314 + $0)),
		i(l, u, E, F0, I),
		i(k, u, v, F0, I),
		(I = String.fromCharCode(55349, 57324 + $0)),
		i(l, u, E, F0, I),
		i(k, u, v, F0, I),
		(I = String.fromCharCode(55349, 57334 + $0)),
		i(l, u, E, F0, I),
		i(k, u, v, F0, I);
}
var st = 'ÐÞþ';
...
var ye = [
	...
	Ee = function (e, t, a) {
		return X[a][e] && X[a][e].replace && (e = X[a][e].replace), { value: e, metrics: ft(e, t, a) };
	},
	...
	_a = function (e, t, a) {
		...
		if (c) {
			...
			if (c === 'boldsymbol') {
				...
				h
					? ((y = Mr[c].fontName), (w = [c]))
					: ((y = xe(c, t.fontWeight, t.fontShape)), (w = [c, t.fontWeight, t.fontShape]));
	...
	s1 = function (e, t) {
		...
		var $ = l0(['vlist-t'], L);
		return L.length === 2 && $.classes.push('vlist-t2'), ($.height = w), ($.depth = -y), $;
	},
	l1 = (r, e) => {
		var t = l0(['mspace'], [], e),
			a = K(r, e);
...
var Ne = function (e) {
		...
		return (
			Yt(
				...
				(z, T) => {
					var C = T.classes[0],
						N = z.classes[0];
					C === 'mbin' && q.contains(c1, N)
						? (T.classes[0] = 'mord')
						: N === 'mbin' && q.contains(m1, C) && (z.classes[0] = 'mord');
				},
				{ node: y },
				w,
				x
	...
	Tr = function (e) {
		return e instanceof ue || e instanceof pt || (e instanceof he && e.hasClass('enclosing'))
			? e
			: null;
	},
	p1 = function r(e, t) {
	...
	for (var s = [], o = [], h = 0; h < a.length; h++)
		if (
			...
			a[h].hasClass('newline') &&
				(o.pop(), o.length > 0 && (s.push(we(o, e)), (o = [])), s.push(a[h]));
...
class c0 {
	...
	toMarkup() {
		...
		for (var t in this.attributes)
			Object.prototype.hasOwnProperty.call(this.attributes, t) &&
				((e += ' ' + t + '="'), (e += q.escape(this.attributes[t])), (e += '"'));
...
function Xt(r, e, t, a, n) {
	var s = o0(r, t),
		o;
	s.length === 1 && s[0] instanceof c0 && q.contains(['mrow', 'mtable'], s[0].type)
		? (o = s[0])
...
var Dr = function (e) {
	...
	g1 = function (e, t, a) {
		var n = Dr(a),
			s;
		if (a.output === 'mathml') return Xt(e, t, n, a.displayMode, !0);
		if (a.output === 'html') {
			var o = ot(e, n);
			s = b.makeSpan(['katex'], [o]);
		} else {
			var h = Xt(e, t, n, a.displayMode, !1),
				c = ot(e, n);
...
var xt = (r, e) => {
		var t, a, n;
		r && r.type === 'supsub'
			? ((a = H(r.base, 'accent')), (t = a.base), (r.base = t), (n = Wa(P(r, e))), (r.base = a))
	...
	Nr = (r, e) => {
		var t = r.isStretchy ? N0.mathMLnode(r.label) : new S.MathNode('mo', [v0(r.label, r.mode)]),
			a = new S.MathNode('mover', [Y(r.base, e), t]);
...
B({
	...
	mathmlBuilder: (r, e) => {
		var t = N0.mathMLnode(r.label),
			a = new S.MathNode('munder', [Y(r.base, e), t]);
...
B({
	...
	mathmlBuilder(r, e) {
		var t = new S.MathNode('mrow', [Y(r.label, e)]);
		return (
...
B({
	...
	mathmlBuilder(r, e) {
		return new S.MathNode('mrow', [Y(r.fragment, e)]);
	}
});
B({
	type: 'textord',
	...
	handler(r, e) {
		for (
			var { parser: t } = r, a = H(e[0], 'ordgroup'), n = a.body, s = '', o = 0;
			o < n.length;
			o++
		) {
			var h = H(n[o], 'textord');
...
B({
	...
	handler(r, e, t) {
		...
		return { type: 'cr', mode: a.mode, newLine: s, size: n && H(n, 'size').value };
	},
	htmlBuilder(r, e) {
...
B({
	...
	handler(r) {
		...
		var n = N1(e);
		return Fr(e, a, n, t === '\\\\globallet'), { type: 'internal', mode: e.mode };
	}
});
B({
	type: 'internal',
...
var ne = function (e, t, a) {
	...
	O1 = function (e, t) {
		var a = t.havingBaseSizing(),
			n = $r('\\surd', e * a.sizeMultiplier, Ur, a),
			s = a.sizeMultiplier,
	...
	H1 = function (e, t, a, n, s) {
		...
		if (q.contains(F1, e)) return Pr(e, se[t], !1, a, n, s);
...
var kt = (r, e) => {
			...
			O = b.makeVList(
				{
					...
					children: [
						{ type: 'elem', elem: t, shift: 0 },
						{ type: 'elem', elem: s, shift: o, wrapperClasses: F }
					]
				},
				e
			);
		...
		return (
			...
			/cancel/.test(a) && !h
				? b.makeSpan(['mord', 'cancel-lap'], [O], e)
				: b.makeSpan(['mord'], [O], e)
		);
	},
	St = (r, e) => {
		var t = 0,
			a = new S.MathNode(r.label.indexOf('colorbox') > -1 ? 'mpadded' : 'menclose', [Y(r.body, e)]);
		switch (r.label) {
			case '\\cancel':
...
var k0 = function (e, t) {
		...
		function V(fe) {
			for (var pe = 0; pe < fe.length; ++pe)
				pe > 0 && (F += 0.25), p.push({ pos: F, isDashed: fe[pe] });
		}
		...
		var e0 = F / 2 + t.fontMetrics().axisHeight,
			U0 = e.cols || [],
			s0 = [],
			g0,
			E0,
		...
		for (n = 0, E0 = 0; n < h || E0 < U0.length; ++n, ++E0) {
			...
			if (!(n >= h)) {
				...
				(n > 0 || e.hskipBeforeAndAfter) &&
					((K0 = q.deflt(m0.pregap, w)),
					K0 !== 0 &&
						((g0 = b.makeSpan(['arraycolsep'], [])), (g0.style.width = A(K0)), s0.push(g0)));
				var J0 = [];
				for (a = 0; a < s; ++a) {
					var ce = c[a],
						de = ce[n];
					if (de) {
						...
						(de.depth = ce.depth),
							(de.height = ce.height),
							J0.push({ type: 'elem', elem: de, shift: ha });
					}
				}
	...
	S0 = function (e, t) {
		for (
			...
			for (var h = e.body[o], c = [], p = 0; p < h.length; p++)
				c.push(new S.MathNode('mtd', [Y(h[p], t)]));
		...
		if (e.cols && e.cols.length > 0) {
			...
			z[0].type === 'separator' && ((w += 'top '), (N = 1)),
				z[z.length - 1].type === 'separator' && ((w += 'bottom '), (O -= 1));
			for (var F = N; F < O; F++)
				z[F].type === 'align'
					? ((x += $1[z[F].align]), C && (T += 'none '), (C = !0))
					: z[F].type === 'separator' &&
						C &&
						((T += z[F].separator === '|' ? 'solid ' : 'dashed '), (C = !1));
...
B({
	...
	handler(r, e) {
		...
		for (var s = '', o = 0; o < n.body.length; ++o) s += H(n.body[o], 'textord').text;
		if (a === '\\begin') {
...
var Jr = (r, e) => {
	...
	At = (r, e) => {
		...
		return (
			r.leftDelim == null
				? (L = oe(e, ['mopen']))
				: (L = B0.customSizedDelim(r.leftDelim, V, !0, e.havingStyle(t), r.mode, ['mopen'])),
			r.continued
				? (U = b.makeSpan([]))
				: r.rightDelim == null
					? (U = oe(e, ['mclose']))
	...
	Tt = (r, e) => {
		var t = new S.MathNode('mfrac', [Y(r.numer, e), Y(r.denom, e)]);
...
B({
	...
	handler(r, e) {
		...
		} else (x = H(x, 'textord')), (w = er[Number(x.text)]);
		return {
			type: 'genfrac',
			mode: t.mode,
			numer: a,
...
var Qr = (r, e) => {
	...
	Y1 = (r, e) => {
		var t = N0.mathMLnode(r.label);
		return new S.MathNode(r.isOver ? 'mover' : 'munder', [Y(r.base, e), t]);
	};
B({
	type: 'horizBrace',
...
B({
	...
	handler: (r, e) => {
		...
		return t.settings.isTrusted(h)
			? { type: 'html', mode: t.mode, attributes: c, body: Q(o) }
...
B({
	...
	mathmlBuilder: (r, e) => {
		var t = new S.MathNode('mpadded', [Y(r.body, e)]);
		if (r.alignment !== 'rlap') {
...
var _r = (r, e, t, a, n, s, o) => {
	...
	re = (r, e) => {
		var t,
			...
			s;
		r.type === 'supsub'
			? ((t = r.sup), (a = r.sub), (s = H(r.base, 'op')), (n = !0))
			: (s = H(r, 'op'));
		var o = e.style,
			h = !1;
	...
	me = (r, e) => {
		...
		if (r.symbol)
			(t = new c0('mo', [v0(r.name, r.mode)])),
				q.contains(ea, r.name) && t.setAttribute('largeop', 'false');
...
var ta = (r, e) => {
		var t,
			...
			s;
		r.type === 'supsub'
			? ((t = r.sup), (a = r.sub), (s = H(r.base, 'operatorname')), (n = !0))
			: (s = H(r, 'operatorname'));
		var o;
		if (s.body.length > 0) {
			for (
...
B({
	...
	mathmlBuilder(r, e) {
		...
		t.setAttribute('stretchy', 'true');
		var a = new S.MathNode('mover', [Y(r.body, e), t]);
		return a.setAttribute('accent', 'true'), a;
	}
});
B({
...
B({
	...
	mathmlBuilder(r, e) {
		...
		return a ? new S.MathNode('mroot', [Y(t, e), Y(a, e)]) : new S.MathNode('msqrt', [Y(t, e)]);
	}
});
...
X0({
	...
	htmlBuilder(r, e) {
		...
		if (h && c) {
			...
			var $ = [{ type: 'elem', elem: c, marginLeft: O, marginRight: N }];
			V = b.makeVList({ positionType: 'shift', positionData: y, children: $ }, e);
		} else if (h)
	...
	mathmlBuilder(r, e) {
		...
		var s = [Y(r.base, e)];
		r.sub && s.push(Y(r.sub, e)), r.sup && s.push(Y(r.sup, e));
		var o;
...
B({
	...
	mathmlBuilder(r, e) {
		var t = new S.MathNode('mo', [new S.TextNode('‾')]);
		t.setAttribute('stretchy', 'true');
		var a = new S.MathNode('munder', [Y(r.body, e), t]);
		return a.setAttribute('accentunder', 'true'), a;
	}
});
B({
	...
	mathmlBuilder(r, e) {
		return new S.MathNode('mpadded', [Y(r.body, e)], ['vcenter']);
	}
});
B({
	type: 'verb',
...
m('\\show', (r) => {
	var e = r.popToken(),
		t = e.text;
	return console.log(e, r.macros.get(t), H0[t], X.math[t], X.text[t]), '';
});
m('\\bgroup', '{');
m('\\egroup', '}');
m('~', '\\nobreakspace');
...
m('\\dots', function (r) {
	...
	return (
		t in cr
			? (e = cr[t])
			: (t.slice(0, 4) === '\\not' ||
					(t in X.math && q.contains(['bin', 'rel'], X.math[t].group))) &&
				(e = '\\dotsb'),
		e
	);
});
...
class s4 {
	...
	isExpandable(e) {
		...
		return t != null
			...
			: H0.hasOwnProperty(e) && !H0[e].primitive;
	}
}
...
class He {
	...
	parseExpression(e, t) {
		for (var a = []; ; ) {
			...
			var n = this.fetch();
			if (
				He.endOfExpression.indexOf(n.text) !== -1 ||
				(t && n.text === t) ||
				(e && H0[n.text] && H0[n.text].infix)
			)
				break;
...
const m4 = { '\\times': '\\text{\\fontfamily{Times New Roman}\\selectfont}' };
function c4(r) {
	return h4.renderToString(r, { macros: m4 });
}
function d4(r) {
	const e = /\$\$(.*?)\$\$/g;
	let t = r;
	return (t = t.replace(e, (a, n) => c4(n))), t;
}
export { d4 as r };
